...
│                                                         │
│  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐  │
│  │  Agents (5)  │  │  Skills (4)  │  │  Templates   │  │
│  │              │  │              │  │     (7)      │  │
│  │ interviewer  │  │ /genesis     │  │ CLAUDE.md    │  │
│  │ planner      │  │ /registry    │  │ settings     │  │
│  │ scaffold-    │  │ /validate    │  │ agent        │  │
│  │   writer     │  │ /update      │  │ skill        │  │
│  │ claude-infra │  │              │  │ mcp.json     │  │
│  │   -writer    │  │              │  │ memory-user  │  │
│  │ finaliser    │  │              │  │ memory-proj  │  │
│  └──────────────┘  └──────────────┘  └──────────────┘  │
│                                                         │
│  ┌──────────────┐  ┌──────────────┐                     │
│  │  References  │  │    Memory    │                     │
...
│                                                         │
│  ┌──────────────────────────────────────────────────┐   │
│  │  User Configuration (gitignored, preserved)      │   │
│  │  personalisation.md  |  environment.md           │   │
│  └──────────────────────────────────────────────────┘   │
│                                                         │
└─────────────────────────────────────────────────────────┘
```
